<template>
	<ion-page>
		...
		<ion-header>
			<div class="primary center v-form"
				style="padding-top: 3px;padding-bottom: 7px;z-index:20;border-bottom: 1px solid #a9acb1;    padding: 8px !important;">
				<span
					style="margin-right:10px;left: 0px;display: inline-block; margin-top: 10px;font-size: 15px;width:30px;"
					@click="$router.back();">
    ...
    width: calc(100% - 40px);">
		...
		<div ref="content" style="overflow-y:auto;height: -webkit-fill-available;">
			...
			<v-dataview ref="dataview" v-bind:autoload="false" class="aaa" src="/api/desarrollo-social/sivico/search"
				pagination="10" :updated="bindLinks($el)" v-bind:filters="filters">
