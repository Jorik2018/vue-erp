<template>
    ...
    <ion-header mode="md">
      <ion-toolbar mode="md">
        <ion-title v-if="session && session.people">
          <div class="center" v-for="(o, i) in [session.people]" v-bind:key="i" style="
                color: white;
                text-align: center;
                white-space: normal;
                padding: 20px;
  ...
  <ion-router-outlet id="main-content" style="display:none"></ion-router-outlet>
</template>
<script lang="ts">
